...
- Timestamp: `2022-06-15 16:43`
- Build ID: `2c2eaff0-9fb3-41b8-8a15-4c419a856bdb`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/2c2eaff0-9fb3-41b8-8a15-4c419a856bdb.git
$ cd 2c2eaff0-9fb3-41b8-8a15-4c419a856bdb
```
